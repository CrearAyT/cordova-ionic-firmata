...
var dummyBoard = {
  ...
  pins: [{"supportedModes":[],"value":0,"report":1,"analogChannel":127},{"supportedModes":[],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,3,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,4],"value":0,"report":1,"analogChannel":127},{"supportedModes":[0,1,2],"value":372,"report":1,"analogChannel":0},{"supportedModes":[0,1,2],"value":241,"report":1,"analogChannel":1},{"supportedModes":[0,1,2],"value":219,"report":1,"analogChannel":2},{"supportedModes":[0,1,2],"value":221,"report":1,"analogChannel":3},{"supportedModes":[0,1,2,6],"value":193,"report":1,"analogChannel":4},{"supportedModes":[0,1,2,6],"value":301,"report":1,"analogChannel":5},{"supportedModes":[2],"value":362,"report":1,"analogChannel":6},{"supportedModes":[2],"value":322,"report":1,"analogChannel":7}],

  version: {"major":2,"minor":3},

  firmware: {"version":{"major":2,"minor":3},"name":"Dummy board like ArduinoNano V3"},
};
...
Board.prototype.processData = function(data) {
    var board = this;
    var byt, cmd;

    if (!board.versionReceived) {
      for (var i = 0; i < data.length; i++) {
        if (data[i] == REPORT_VERSION) {
          board.versionReceived = true;
          break;
        }
      }
...
/**
 * Fill internal structures from an optional template, faking
 * queryCapabilities(), queryAnalogMapping(), queryVersion() and queryFirmware()
 */

Board.prototype.fakeInit = function(template) {
  var template = template || dummyBoard;

  this.pins.length = 0;
  this.analogPins.length = 0;

  if (template.pins) {
    for(var i=0; i < template.pins.length; i++) {
      this.pins.push(template.pins[i]);
    }
  }

  if (template.analogPins) {
    for(var i=0; i < template.analogPins.length; i++) {
      this.analogPins.push(template.pins[i]);
    }
  }

  this.version = template.version || {"major":0,"minor":0};
  this.firmware = template.firmware || {"version":{"major":0,"minor":0},"name":"Dummy board"};
